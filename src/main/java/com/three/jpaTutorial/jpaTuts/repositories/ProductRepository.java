...
public interface ProductRepository extends JpaRepository<ProductEntity,Long> {
   ...
   //Optional<ProductEntity> findByTitleAndPrice(String title, BigDecimal price); //as title an dprice combination we hav egiven in the constratint taht coombination of both is unique..so it will return only one element or null
